...
package section.index
{
	...
	public class Main extends MovieClip
	{
		...
		public function Initial( a_event : Event = null ) : void
		{
			...
			// Motor Torque : 馬達扭力
			// create obstacle
			draw_box(this.stage.stageWidth / 2, 0, this.stage.stageWidth, 50, false, 1, 1);
			draw_box(this.stage.stageWidth / 2, this.stage.stageHeight, this.stage.stageHeight, 50, false, 1, 1);
			draw_box(0, this.stage.stageHeight / 2, 50, this.stage.stageWidth, false, 1, 1);
			draw_box(this.stage.stageWidth, this.stage.stageHeight / 2, 50, this.stage.stageHeight, false, 1, 1);
			...
			for ( var i : Number = 0; i < 10 ; i++) {
                ...
                ks = this.draw_kinematic( 50, 50+40 * i, 10 );
		...
		// 動能物件
		public function draw_kinematic(px,py,r) : b2Body 
		{
